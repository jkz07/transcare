  ...
  const mockEvents = [
    {
      ...
      date: "2025-07-05",
      time: "15:00",
      location: "Centro Comunitário - Salvador, BA",
      organizer: "Coletivo TransBA",
      attendees: 23,
      maxAttendees: 30,
    ...
    },
    {
      ...
      date: "2025-07-10",
      time: "19:00",
      location: "YouTube - Canal TransCare Bahia",
    ...
    },
    {
      ...
      date: "2025-07-15",
      time: "14:00",
      location: "Espaço Cultural da Barroquinha - Salvador, BA",
      organizer: "TransSalvador Coletivo",
      attendees: 78,
      maxAttendees: 100,
      description: "Encontro mensal da comunidade trans de Salvador com atividades, palestras e muito networking.",
      category: "Encontro",
      price: "R$ 10,00"
    },
    {
      ...
      date: "2025-07-20",
      time: "10:00",
      location: "Centro de Bem-estar - Feira de Santana, BA",
      organizer: "Instituto TransVida Bahia",
      attendees: 34,
      maxAttendees: 50,
  ...
  const pastEvents = [
    {
      ...
      date: "2025-01-29",
      location: "Campo Grande - Salvador, BA",
      attendees: 5000,
    ...
    },
    {
      ...
      date: "2025-03-15",
      location: "Universidade Federal da Bahia - Salvador, BA",
      attendees: 200,
      category: "Acadêmico"
    }
  ];
