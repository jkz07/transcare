  ...
  return <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          return <Card key={index} className="card-trans cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl" onClick={() => handleCardClick(link.url)}>
                ...
                <CardContent className="text-center">
                  ...
                  <Button className={`w-full ${link.color} transition-colors`} onClick={e => {
                e.stopPropagation();
